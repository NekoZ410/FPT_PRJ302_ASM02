<%-- 
    Document   : addProduct
    Created on : Dec 11, 2024, 1:32:27 PM
    Author     : Admin
--%>
...
<%
    ...
    ArrayList<Order> lo;
    if (request.getAttribute("lo") == null){
        lo = new OrderDAO().getListOrderAll(u.getUserID());
    } else {
        lo = (ArrayList) request.getAttribute("listOrder");
    }
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="titlepage" style="padding-bottom: 20px">
                            <h2 style="max-width: 800px">Order product</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="our_products" style="width: 160%; margin-left: -30%">
                            <form action="productChange" method="post" class="row" style="text-align: center; border: 5px solid royalblue; border-radius: 10px">
                                <div class="col-md-2 margin_bottom1">
                                    <h3>Image</h3>                                    
                                </div>                               
                                ...
                                <c:forEach items="${lo}" var="o">
                                    <div class="col-md-2 margin_bottom1">
                                        <img src="${o.getProductID().getImage()}" alt="alt" style="max-width: 150px; min-height: 150px"/>                            
                                    </div>                               
                                    <div class="col-md-4 margin_bottom1">
                                        <h3>${o.getProductID().getProductName()}</h3>
                                    </div>                               
                                    <div class="col-md-2 margin_bottom1">
                                        <h3>
                                            <del>${o.getProductID().getUnitPrice()}₫</del>
                                            <br>
                                            <strong>${o.getProductID().getDiscountedPrice()}₫</strong>
                                        </h3>
                                    </div>    
                                    <div class="col-md-1 margin_bottom1">
                                        <h3>${o.getQuantity()}</h3>
                                    ...
                                    <div class="col-md-1 margin_bottom1">
                                        <h3>${o.getOrderDate()}</h3>
                                    </div>
                                    <c:set var="sum" value="${sum + (o.getProductID().getDiscountedPrice() * o.getQuantity())}"></c:set>
                                        <div class="col-md-2 margin_bottom1">
                                            <h3><fmt:formatNumber value="${o.getProductID().getDiscountedPrice() * o.getQuantity()}" pattern="#########.#" />₫</h3>
                                    </div>
                                </c:forEach>
                                <div class="col-md-2 margin_bottom1">
                                    <h3></h3>                                    
                    ...
                    <div class="col-md-12">
                        <div class="titlepage" style="padding-bottom: 20px">
                            <h2 style="max-width: 800px">Information</h2>
                        </div>
                    </div>      
                </div>
                <div class="our_products" style="width: 120%; margin-left: -10%">
                    <form action="purchase" method="post" class="row" style="text-align: center; border: 5px solid royalblue; border-radius: 10px">
                        <div class="col-md-2 margin_bottom1">
                            <h3>Real Name</h3>                                    
                        </div>
                        <div class="col-md-2 margin_bottom1">
                        ...
                        <div class="col-md-2 margin_bottom1">
                            <input type="text" name="pname" value="${sessionScope.userAccount.getRealName()}">
                        </div>
                        <div class="col-md-2 margin_bottom1">
                            <input type="text" name="pusername" value="${sessionScope.userAccount.getUserName()}">
                        </div>
                        <div class="col-md-3 margin_bottom1">
                            <input type="text" name="pemail" value="${sessionScope.userAccount.getEmail()}">
                        </div>
                        <div class="col-md-3 margin_bottom1">
                            <input type="text" name="paddress" value="" placeholder="Your address here">
                        </div>
                        <div class="col-md-2 margin_bottom1">
                            <select name="pmethod">
                        ...
                        <button class="read_more" type="submit">Purchase</button>
                    </form>
                </div>
            </div>
        </div>
