<%-- 
    Document   : categories
    Created on : Dec 10, 2024, 11:52:21 AM
    Author     : Admin
--%>
                            ...
                            <div class="row" style="text-align: center">
                                <div class="col-md-3 margin_bottom1">
                                    <div class="product_box">
                                        <figure><a href="search?cid=1&mode=cate"><img src="images/categories/product1.png" alt="#"/></a></figure>
                                        <h3><a href="search?cid=1&mode=cate">PC</a></h3>
                                    </div>
                                </div>
                                <div class="col-md-3 margin_bottom1">
                                    <div class="product_box">
                                        <figure><a href="search?cid=2&mode=cate"><img src="images/categories/product2.png" alt="#"/></a></figure>
                                        <h3><a href="search?cid=2&mode=cate">Laptop</a></h3>
                                    </div>
                                </div>
                                <div class="col-md-3 margin_bottom1">
                                    <div class="product_box">
                                        <figure><a href="search?cid=3&mode=cate"><img src="images/categories/product3.png" alt="#"/></a></figure>
                                        <h3><a href="search?cid=3&mode=cate">Tablet</a></h3>
                                    </div>
                                </div>
                                <div class="col-md-3 margin_bottom1">
                                    <div class="product_box">
                                        <figure><a href="search?cid=4&mode=cate"><img src="images/categories/product4.png" alt="#"/></a></figure>
                                        <h3><a href="search?cid=4&mode=cate">Speaker</a></h3>
                                    </div>
                                </div>
                                <div class="col-md-3 margin_bottom1">
                                    <div class="product_box">
                                        <figure><a href="search?cid=5&mode=cate"><img src="images/categories/product5.png" alt="#"/></a></figure>
                                        <h3><a href="search?cid=5&mode=cate">Networking</a></h3>
                                    </div>
                                </div>
                                <div class="col-md-3 margin_bottom1">
                                    <div class="product_box">
                                        <figure><a href="search?cid=6&mode=cate"><img src="images/categories/product6.png" alt="#"/></a></figure>
                                        <h3><a href="search?cid=6&mode=cate">Storage</a></h3>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="product_box">
                                        <figure><a href="search?cid=7&mode=cate"><img src="images/categories/product7.png" alt="#"/></a></figure>
                                        <h3><a href="search?cid=7&mode=cate">Memory</a></h3>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="product_box">
                                        <figure><a href="search?cid=8&mode=cate"><img src="images/categories/product8.png" alt="#"/></a></figure>
                                        <h3><a href="search?cid=8&mode=cate">Battery</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
