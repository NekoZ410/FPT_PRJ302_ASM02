                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="titlepage" style="padding-bottom: 20px">
                            <h2 style="max-width: 800px">Edit product</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="our_products" style="width: 160%; margin-left: -30%">
                            <form action="productChange" method="post" class="row" style="text-align: center">
                                <div class="col-md-1 margin_bottom1">
                                    <h3>ProductID</h3>
                                    <h3><input type="text" name="pid" value="${p.getProductID()}" style="width: 90%"></h3>
                                </div>                               
                                <div class="col-md-3 margin_bottom1">
                                    <h3>ProductName</h3>
                                    <h3><input type="text" name="pname" value="${p.getProductName()}"></h3>
                                </div>                               
                                <div class="col-md-1 margin_bottom1">
                                    <h3>CategoryID</h3>
                                    <h3><input type="text" name="cid" value="${p.getCategoryID().getCategoryID()}" style="width: 40%"></h3>
                                </div>    
                                <div class="col-md-1 margin_bottom1">
                                    <h3>UnitsInStock</h3>
                                    <h3><input type="text" name="pstock" value="${p.getUnitsInStock()}" style="width: 40%"></h3>
                                </div>
                                <div class="col-md-1 margin_bottom1">
                                    <h3>UnitPrice</h3>
                                    <h3><input type="text" name="pprice" value="${p.getUnitPrice()}" style="width: 40%"></h3>
                                </div>
                                <div class="col-md-1 margin_bottom1">
                                    <h3>Discount</h3>
                                    <h3><input type="text" name="pdiscount" value="${p.getDiscount()}" style="width: 40%"></h3>
                                </div>   
                                <div class="col-md-3 margin_bottom1">
                                    <h3>Image</h3>
                                    <h3><input type="text" name="pimage" value="${p.getImage()}" ></h3>
                                </div> 
                                <div class="col-md-1 margin_bottom1">
                                    <h3></h3>
                                    <button type="submit" class="read_more" name="cmode" value="pedit">Save</button>
                                </div>                 
                            </form>                                            
                        </div>
                    </div>
