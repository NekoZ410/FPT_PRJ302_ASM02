...
<%
    ...
    if (u.getRole().equals("user")){
        ArrayList<Payment> lpay = payd.getPaymentByUserID(u.getUserID());
        request.setAttribute("lpay", lpay);
    } else {
        ArrayList<Payment> lpay = payd.getPaymentAll();
        request.setAttribute("lpay", lpay);
    }
    ...
    <body class="main-layout inner_posituong">
        ...
        <div  class="products">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="titlepage" style="padding-bottom: 20px">
                            <h2 style="max-width: 800px">Purchased information</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="our_products" style="width: 160%; margin-left: -30%">
                            <form action="productChange" method="post" class="row" style="text-align: center; border: 5px solid royalblue; border-radius: 10px">
                                ...
                                <c:forEach items="${lpay}" var="pay">
                                    <div class="col-md-2 margin_bottom1">
                                        <h3>${pay.getPaymentID()}</h3>                                    
                                    </div>                               
                                    <div class="col-md-2 margin_bottom1">
                                        <h3>${pay.getPaymentDate()}</h3>
                                    </div>                               
                                    <div class="col-md-4 margin_bottom1">
                                        <h3>${pay.getAddress()}</h3>
                                    </div>    
                                    <div class="col-md-2 margin_bottom1">
                                        <h3>${pay.getPaymentMethod()}</h3>
                                    </div>
                                    <div class="col-md-2 margin_bottom1">
                                        <h3>${pay.getPrice()}</h3>
                                    </div>
            ...
            <div style="text-align: center">
                <a class="read_more" href="index.jsp">Back to homepage</a>   
            </div>        
        </div>
        <!-- end products -->
