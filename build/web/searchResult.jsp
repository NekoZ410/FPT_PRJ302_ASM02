<%-- 
    ...
    Created on : Dec 10, 2024, 11:50:36 AM
    Author     : Admin
--%>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="titlepage" style="padding-bottom: 20px">
                            <h2 style="max-width: 800px">Search result: </h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                                ...
                                <c:forEach items="${lp}" var="p">
                                    <div class="col-md-3 margin_bottom1">
                                        <div class="product_box">
                                            <figure><a href="product?pid=${p.getProductID()}"><img src="${p.getImage()}" alt="" style="max-width: 350px; min-height: 350px"/></a></figure>
                                            <h3 style="background-color: transparent; color: black">${p.getUnitPrice()}₫</h3>
                                            <h3><a href="product?pid=${p.getProductID()}" style="color: white">${p.getProductName()}</a></h3>
                                        </div>
                                    </div>
                                </c:forEach>
                            </div>
