...
<html lang="en">
    ...
    <body class="main-layout inner_posituong">
        ...
        <div  class="products">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="titlepage" style="padding-bottom: 20px">
                            <h2 style="max-width: 800px">In cart</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="our_products" style="width: 160%; margin-left: -30%">
                            <form action="productChange" method="post" class="row" style="text-align: center; border: 5px solid royalblue; border-radius: 10px">
                                ...
                                <c:forEach items="${lcart}" var="c">
                                    <div class="col-md-2 margin_bottom1">
                                        <img src="${pd.getProductByID(c.getProductID()).getImage()}" alt="alt" style="max-width: 150px; min-height: 150px"/>                            
                                    </div>                               
                                    <div class="col-md-4 margin_bottom1">
                                        <h3>${pd.getProductByID(c.getProductID()).getProductName()}</h3>
                                    </div>                               
                                    <div class="col-md-2 margin_bottom1">
                                        <h3>
                                            <del>${pd.getProductByID(c.getProductID()).getUnitPrice()}₫</del>
                                            <br>
                                            <strong>${pd.getProductByID(c.getProductID()).getDiscountedPrice()}₫</strong>
                                        </h3>
                                    </div>    
                                    <div class="col-md-1 margin_bottom1">
                                        <h3>${c.getQuantity()}</h3>
                                    </div>
                                    <c:set var="sum" value="${sum + (pd.getProductByID(c.getProductID()).getDiscountedPrice() * c.getQuantity())}"></c:set>
                                        <div class="col-md-2 margin_bottom1">
                                            <h3><fmt:formatNumber value="${pd.getProductByID(c.getProductID()).getDiscountedPrice() * c.getQuantity()}" pattern="#########.#" />₫</h3>
                                    </div>
                                    <div class="col-md-1 margin_bottom1">
                                        <h3><a class="read_more" href="deleteCart?cartid=${c.getCartID()}">Delete</a></h3>
                                    </div>
                                </c:forEach>
                                <div class="col-md-2 margin_bottom1">
                                    <h3></h3>                                    
            ...
            <form action="orderViaCart" method="post" style="text-align: center">
