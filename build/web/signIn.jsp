<%-- 
    Document   : signIn
    Created on : Dec 10, 2024, 4:51:25 PM
    Author     : Admin
--%>
                    ...
                    <div class="row" style="justify-content: center">                    
                        <div class="login-form" style="border: 5px solid black; border-radius: 10px; padding: 20px; width: 50%; background-color: wheat">
                            <p style="text-align: center; width: 100%; border-radius: 10px">
                                <input type="text" name="username" value="${username}" placeholder="   Username" style="width: 100%; border-radius: 10px"></p>
                            <p>&nbsp;</p>
                            <p style="text-align: center; width: 100%; border-radius: 10px">
                                <input type="password" name="password" value="${password}" placeholder="   Password" style="width: 100%; border-radius: 10px"></p>
                            <p>&nbsp;</p>
                            <p style="display: flex;justify-content: space-evenly;">
                                <button class="small-button"><a href="forgetPassword.jsp">Forgot password</a></button> 
                                <button class="small-button"><a href="signUp.jsp">No account? Sign Up</a></button></p>
                            <p>&nbsp;</p>
                            <p>${err}</p>
                            <p>&nbsp;</p>
                            <p><button class="large-button" type="submit">Sign In</button></p>
                        </div>
                    </div>
                </form>
            </div>
