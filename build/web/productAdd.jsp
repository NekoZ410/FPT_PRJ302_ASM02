                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="titlepage" style="padding-bottom: 20px">
                            <h2 style="max-width: 800px">Add product</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="our_products" style="width: 160%; margin-left: -30%">
                            <form action="productChange" method="post" class="row" style="text-align: center">
                                <div class="col-md-1 margin_bottom1">
                                    <h3>ProductID</h3>
                                    <h3><input type="text" name="pid" value="Auto Incre." disabled style="width: 90%"></h3>
                                </div>                               
                                <div class="col-md-3 margin_bottom1">
                                    <h3>ProductName</h3>
                                    <h3><input type="text" name="pname" value=""></h3>
                                </div>                               
                                <div class="col-md-1 margin_bottom1">
                                    <h3>CategoryID</h3>
                                    <h3><input type="text" name="cid" value="" style="width: 40%"></h3>
                                </div>    
                                <div class="col-md-1 margin_bottom1">
                                    <h3>UnitsInStock</h3>
                                    <h3><input type="text" name="pstock" value="" style="width: 40%"></h3>
                                </div>
                                <div class="col-md-1 margin_bottom1">
                                    <h3>UnitPrice</h3>
                                    <h3><input type="text" name="pprice" value="" style="width: 40%"></h3>
                                </div>
                                <div class="col-md-1 margin_bottom1">
                                    <h3>Discount</h3>
                                    <h3><input type="text" name="pdiscount" value="" style="width: 40%"></h3>
                                </div>   
                                <div class="col-md-3 margin_bottom1">
                                    <h3>Image</h3>
                                    <h3><input type="text" name="pimage" value="" ></h3>
                                </div> 
                                <div class="col-md-1 margin_bottom1">
                                    <h3></h3>
                                    <button type="submit" class="read_more" name="cmode" value="padd">Add</button>
                                </div>                 
                            </form>                                            
                        </div>
                    </div>
